...
private func seeks(_ plan: Plan) -> Bool {
  ...
  case let .topN(_, _, _, source): seeks(source)
  case let .distinct(source): seeks(source)
  case let .aggregate(_, _, source), let .window(_, source): seeks(source)
...
private func joins(_ plan: Plan) -> Bool {
  ...
  case let .topN(_, _, _, source): joins(source)
  case let .distinct(source): joins(source)
  case let .aggregate(_, _, source), let .window(_, source): joins(source)
...
private func residual(_ plan: Plan) -> Bool {
  ...
  case let .topN(_, _, _, source): residual(source)
  case let .distinct(source): residual(source)
  case let .aggregate(_, _, source), let .window(_, source): residual(source)
